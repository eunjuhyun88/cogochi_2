...
export const FEATURES: FeatureItem[] = [
  ...
  { label: 'AGENT HQ', sub: 'PROOF & RELEASE', brief: 'YOUR TRAINING, RECORD, AND RELEASE STORY IN ONE PLACE.', img: '/blockparty/f5-doge-excited.png', path: '/agent?tab=record',
    detail: 'WIN RATE · LP SCORE · CREW READINESS · RELEASE GATES — EVERY ARENA BATTLE BUILDS THE AGENT HQ RECORD.',

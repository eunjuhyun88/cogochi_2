...
export const handle: Handle = async ({ event, resolve }) => {
  ...
  response.headers.set('Content-Security-Policy', [
    ...
    "object-src 'none'",
    "form-action 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' https://unpkg.com https://cloud.umami.is https://va.vercel-scripts.com",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.prod.website-files.com",
    "img-src 'self' data: blob: https:",
    "font-src 'self' https://fonts.gstatic.com",
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.binance.com wss://stream.binance.com https://vitals.vercel-insights.com https://va.vercel-scripts.com",
  ].join('; '));
